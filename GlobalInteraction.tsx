...
export const GlobalInteraction: React.FC = () => {
  ...
  useEffect(() => {
    ...
    let mouseX = -100;
    let mouseY = -100;
    // Cache event target outside requestAnimationFrame to prevent stale closures
    ...
    const move = (e: MouseEvent) => {
      ...
      if (!rafId) {
        rafId = requestAnimationFrame(() => {
          ...
          // Using cached eventTarget instead of elementFromPoint to avoid synchronous layout recalculation/thrashing
