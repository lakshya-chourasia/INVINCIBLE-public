    ...
    const move = (e: MouseEvent) => {
      ...
      if (!rafId) {
        rafId = requestAnimationFrame(() => {
          ...
          // Calculate interactable target synchronously without forcing layout recalculation
          const clickable = !!currentTarget?.closest('button, a, .interactive, input, .sm-toggle, .sm-resize-handle, .sm-logo');
