    ...
    const move = (e: MouseEvent) => {
      ...
      if (!rafId) {
        rafId = requestAnimationFrame(() => {
          ...
          // ⚡ Bolt Performance Optimization: Replace document.elementFromPoint with cached e.target
          // Why: elementFromPoint inside RAF forces synchronous layout recalculations (thrashing)
          // Impact: Eliminates forced reflows during high-frequency mousemove events, improving framerate
