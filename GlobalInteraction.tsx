    ...
    const move = (e: MouseEvent) => {
      ...
      if (!rafId) {
        rafId = requestAnimationFrame(() => {
          ...
          // ⚡ Bolt Performance Optimization: Use cached e.target instead of document.elementFromPoint
          // Why: document.elementFromPoint inside requestAnimationFrame forces synchronous layout recalculations (layout thrashing) on every frame.
          // Impact: Eliminates layout thrashing during mouse movement, significantly improving scroll/animation framerate and reducing CPU usage.
