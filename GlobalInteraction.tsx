...
export const GlobalInteraction: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Why: document.elementFromPoint inside requestAnimationFrame forces synchronous layout recalculations (layout thrashing) on high-frequency events.
    // Impact: Reduces CPU usage and prevents frame drops during rapid mouse movements by caching the event target.
