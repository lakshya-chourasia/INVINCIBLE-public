    ...
    const move = (e: MouseEvent) => {
      ...
      if (!rafId) {
        rafId = requestAnimationFrame(() => {
          ...
          // Why: Calling document.elementFromPoint immediately after style.setProperty forces a synchronous layout recalculation (layout thrashing).
          // Impact: Prevents main thread blocking during high-frequency mousemove events by using the cached target.
