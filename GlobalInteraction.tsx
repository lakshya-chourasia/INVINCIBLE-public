    ...
    const move = (e: MouseEvent) => {
      ...
      if (!rafId) {
        rafId = requestAnimationFrame(() => {
          ...
          // Replaced document.elementFromPoint with cached e.target from the event.
          // This avoids forced synchronous layout recalculations (layout thrashing)
          // on every animated frame, improving rendering performance during high-frequency mouse movements.
