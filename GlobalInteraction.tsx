    ...
    const move = (e: MouseEvent) => {
      ...
      if (!rafId) {
        rafId = requestAnimationFrame(() => {
          ...
          // Why: document.elementFromPoint inside requestAnimationFrame forces synchronous layout recalculations (thrashing).
          // Impact: Using the cached e.target from the MouseEvent prevents main thread blocking and delivers smoother cursor tracking (~60fps).
