    ...
    const move = (e: MouseEvent) => {
      ...
      if (!rafId) {
        rafId = requestAnimationFrame(() => {
          ...
          // ⚡ Bolt Performance Optimization: Caching e.target instead of using document.elementFromPoint
          // Why: document.elementFromPoint forces synchronous layout recalculations and causes layout thrashing
          // Impact: Eliminates forced reflows during high-frequency mousemove events, significantly improving main thread performance
