    ...
    const move = (e: MouseEvent) => {
      ...
      if (!rafId) {
        rafId = requestAnimationFrame(() => {
          ...
          // ⚡ Bolt Performance Optimization: Calling document.elementFromPoint immediately after style.setProperty forces synchronous layout thrashing. We use the cached event target instead to avoid dropped frames during mousemove events.
