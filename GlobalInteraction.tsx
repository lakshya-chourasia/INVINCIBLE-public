    ...
    const move = (e: MouseEvent) => {
      ...
      if (!rafId) {
        rafId = requestAnimationFrame(() => {
          ...
          // ⚡ Bolt Performance Optimization: Use e.target instead of document.elementFromPoint
          // after style modifications to prevent synchronous layout thrashing (forces recalculation).
          // Impact: Eliminates expensive DOM re-layouts on every mousemove frame.
