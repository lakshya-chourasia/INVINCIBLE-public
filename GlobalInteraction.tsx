    ...
    const move = (e: MouseEvent) => {
      ...
      if (!rafId) {
        rafId = requestAnimationFrame(() => {
          ...
          // ⚡ Bolt Performance Optimization: Replaced document.elementFromPoint with cached e.target.
          // Why: elementFromPoint inside RAF forces synchronous layout recalculations (layout thrashing).
          // Impact: Significantly reduces main thread blocking and CPU usage during mouse movement.
