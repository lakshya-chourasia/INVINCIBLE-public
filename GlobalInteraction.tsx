...
export const GlobalInteraction: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Why: elementFromPoint inside RAF forces synchronous layout calculations
    // Impact: Prevents layout thrashing, significantly reducing frame drops during mouse movement
