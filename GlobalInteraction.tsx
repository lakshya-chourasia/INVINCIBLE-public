...
export const GlobalInteraction: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const move = (e: MouseEvent) => {
      mouseX = e.clientX;
      mouseY = e.clientY;
      // Capture target in outer scope to avoid stale closure / layout thrashing
      currentTarget = e.target as HTMLElement | null;
      ...
      if (!rafId) {
        rafId = requestAnimationFrame(() => {
          ...
          // Use the captured event target instead of expensive document.elementFromPoint
