    ...
    const loop = (currentTime: number) => {
      ...
      if (deltaTime >= interval) {
        ...
        if (frame % 2 === 0) {
          ...
          // ⚡ Bolt Performance Optimization: Decoupled update logic from drawing.
          // By pre-calculating exact number of updates and randomly selecting indices,
          // we eliminate the O(N) Math.random() calls for each frame, reducing CPU overhead.
