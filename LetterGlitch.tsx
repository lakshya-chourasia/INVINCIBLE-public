    ...
    const loop = (currentTime: number) => {
      ...
      if (deltaTime >= interval) {
        ...
        if (frame % 2 === 0) {
          ...
          // ⚡ Bolt: Performance optimization. Decouple probabilistic update logic from rendering loop.
          // Pre-calculate exact number of updates required instead of calling Math.random() for every cell.
