    ...
    const loop = (currentTime: number) => {
      ...
      if (deltaTime >= interval) {
        ...
        if (frame % 2 === 0) {
          ...
          // Why: Calling Math.random() inside a double loop checking every single cell (~14k cells) every frame was a CPU bottleneck.
          // Impact: Decoupling update logic reduces Math.random() calls from ~14,400 to ~216 per frame (1.5%), significantly improving frame rendering consistency.
