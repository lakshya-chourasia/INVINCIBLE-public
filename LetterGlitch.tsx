    ...
    const loop = (currentTime: number) => {
      ...
      if (deltaTime >= interval) {
        ...
        if (frame % 2 === 0) {
          ...
          const cellsToUpdate = Math.floor(totalCells * updateChance);

          // ⚡ Bolt: Performance optimization - pre-calculate updates and mutate directly
          // rather than evaluating Math.random() conditionally for every cell iteratively.
