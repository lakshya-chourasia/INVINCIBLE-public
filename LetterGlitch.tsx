    ...
    const loop = (currentTime: number) => {
      ...
      if (deltaTime >= interval) {
        ...
        if (frame % 2 === 0) {
          ...
          // Pre-calculate exact number of updates and target random cells instead of O(N) probabilistic checks
          const updatesNeeded = Math.floor(cols * rows * updateChance);
