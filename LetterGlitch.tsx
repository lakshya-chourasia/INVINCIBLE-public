    ...
    const loop = (currentTime: number) => {
      ...
      if (deltaTime >= interval) {
        ...
        if (frame % 2 === 0) {
          ...
          // ⚡ Bolt: Pre-calculate updates instead of iterating probabilistic checks per cell.
          // Reduces Math.random() calls by ~98% in high-frequency loop for better performance.
