    ...
    const loop = (currentTime: number) => {
      ...
      if (deltaTime >= interval) {
        ...
        if (frame % 2 === 0) {
          ...
          const updatesCount = Math.floor(totalCells * updateChance);

          // ⚡ Bolt: Performance optimization - pre-calculate random updates instead of evaluating Math.random() for every single cell iteratively
