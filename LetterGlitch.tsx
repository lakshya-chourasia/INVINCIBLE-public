    ...
    const loop = (currentTime: number) => {
      ...
      if (deltaTime >= interval) {
        ...
        if (frame % 2 === 0) {
          ...
          // ⚡ Bolt: Performance optimization - pre-calculate the number of cell updates
          // and directly update randomly selected indices instead of evaluating Math.random() iteratively for every cell.
