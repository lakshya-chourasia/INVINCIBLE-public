    ...
    const loop = (currentTime: number) => {
      ...
      if (deltaTime >= interval) {
        ...
        if (frame % 2 === 0) {
          ...
          // Instead of evaluating Math.random() for all 14k+ cells (O(N)),
          // we precalculate the number of updates and randomly select indices.
          // This reduces Math.random() calls from O(cols * rows) to O(cols * rows * updateChance).
