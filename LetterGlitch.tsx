    ...
    const loop = (currentTime: number) => {
      ...
      if (deltaTime >= interval) {
        ...
        if (frame % 2 === 0) {
          ...
          // Why: Decouple O(N) random calls by calculating exact number of updates and randomly picking indices.
          // Impact: Reduces `Math.random()` calls from ~14,000 (depending on screen size) to ~210 per frame.
