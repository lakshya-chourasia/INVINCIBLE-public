    ...
    const loop = (currentTime: number) => {
      ...
      if (deltaTime >= interval) {
        ...
        if (frame % 2 === 0) {
          ...
          // Decoupled probabilistic checks from the rendering loop.
          // Pre-calculating the exact number of updates and directly targeting random indices
          // eliminates O(N) calls to Math.random() per frame, significantly reducing CPU usage.
