    ...
    const loop = (currentTime: number) => {
      ...
      if (deltaTime >= interval) {
        ...
        if (frame % 2 === 0) {
          ...
          // Instead of evaluating Math.random() for every cell, calculate total
          // updates and directly target random cells to significantly reduce frame execution time.
          const totalCells = cols * rows;
          const updateCount = Math.floor(totalCells * updateChance);
