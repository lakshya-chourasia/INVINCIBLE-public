    ...
    const loop = (currentTime: number) => {
      ...
      if (deltaTime >= interval) {
        ...
        if (frame % 2 === 0) {
          ...
          // ⚡ Bolt: Decouple probabilistic updates from the rendering loop
          // Instead of calling Math.random() for every cell (O(N)), calculate
          // the exact number of updates and target random cells directly.
