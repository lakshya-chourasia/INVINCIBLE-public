    ...
    const loop = (currentTime: number) => {
      ...
      if (deltaTime >= interval) {
        ...
        if (frame % 2 === 0) {
          ...
          // ⚡ Bolt: Performance optimization - Pre-calculate number of cells to update and randomly select indices instead of calling Math.random() for every single cell.
