    ...
    const loop = (currentTime: number) => {
      ...
      if (deltaTime >= interval) {
        ...
        if (frame % 2 === 0) {
          ...
          // ⚡ Bolt Performance Optimization: Decoupled update logic to eliminate O(N) Math.random() calls
          // for each cell, measurably reducing CPU overhead during high-frequency rendering.
